...
import com.JoseDiaz.entities.sessionsbeans.HorariosFacadeLocal;
...
public class HorariosController implements Serializable {
    ...
    @EJB
    private HorariosFacadeLocal ejbFacade;
    ...
    private HorariosFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public static class HorariosControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Horarios) {
                ...
                return getStringKey(o.getIdhorarios());
            } else {
